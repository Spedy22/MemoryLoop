...
function changeTime(ms) {
    ...
    let hrs = Math.floor(ms / 3600000) % 24;
    let days = Math.floor(ms / 86400000);
    return `${String(days).padStart(2, "0")}:${String(hrs).padStart(2, "0")}:${String(min).padStart(2, "0")}:${String(sec).padStart(2, "0")}`;
}

},{"notiflix":"hpqv0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"hpqv0":[function(require,module,exports,__globalThis) {
var global = arguments[3];
...
},{}]},["6DHTQ","6kb64"], "6kb64", "parcelRequire09fa", {})

//# sourceMappingURL=MemoryLoop.6528c13b.js.map
